    ...
    rulebase = {
        "job_profiles": {
            ...
            "it_dozent": {
                ...
                "experience_required": {"general": 3, "it": 5},
                "education_min": "bachelor",
                "salary_range": {"min": 46000, "max": 62000},
                "description": "Vermittlung von IT-Wissen in Bildungseinrichtungen und Unternehmen",
                "requirements": ["Tiefe IT-Fachkenntnisse", "Pädagogische Fähigkeiten", "Kommunikationsstärke", "Didaktische Kompetenz"],
                "hard_skills": {
                    "linux": 3,
                    "windows-server": 3,
                    "python": 3,
            ...
            "web_developer": {
                ...
                "description": "Entwicklung und Wartung von Websites und Webanwendungen",
                "requirements": ["HTML/CSS/JavaScript", "Frontend-Frameworks", "Responsive Design"],
                "hard_skills": {
                    "html-css": 4,
                    "javascript": 4,
                    "react": 3,
            ...
            "data_analyst": {
                ...
                "education_min": "bachelor",
                "salary_range": {"min": 45000, "max": 70000},
                "description": "Analyse und Interpretation von Daten zur Geschäftsentscheidung",
                "requirements": ["SQL", "Python/R", "Statistik", "Datenvisualisierung"],
                "hard_skills": {
                    "sql": 4,
                    "python": 4,
                    "excel": 4,
            ...
            "cloud_engineer": {
                ...
                "requirements": ["AWS/Azure/GCP", "DevOps", "Containerisierung", "Automatisierung"],
                "hard_skills": {
                    "aws": 4,
                    "azure": 4,
                    "docker": 4,
            ...
            "devops_engineer": {
                ...
                "level": "senior",
                "experience_required": {"general": 3, "it": 4},
                "education_min": "bachelor",
                "salary_range": {"min": 60000, "max": 90000},
                "description": "Automatisierung und Optimierung von Entwicklungs- und Deployment-Prozessen",
                "requirements": ["CI/CD", "Containerisierung", "Infrastructure as Code", "Monitoring"],
                "hard_skills": {
                    "docker": 4,
                    "kubernetes": 4,
                    "jenkins": 3,
...
function initializeEventListeners() {
    ...
    // Language dropdown selections
    document.addEventListener('change', function(e) {
        if (e.target.classList.contains('language-select')) {
            handleLanguageSelection(e.target);
        }
    });
...
function handleLanguageSelection(selectElement) {
    const skill = selectElement.getAttribute('data-skill');
    const value = selectElement.value;

    // Update skill rating
    if (value === '') {
        // Remove skill if no selection
        delete userSkills[skill];
    } else {
        userSkills[skill] = parseInt(value);
    }

    // Add visual feedback with animation
    selectElement.style.transform = 'scale(1.05)';
    selectElement.style.transition = 'transform 0.15s ease-in-out';
    setTimeout(() => {
